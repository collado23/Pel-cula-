...
/* === 61f4c33ea3300d41b27b413ae33b4b64 === */
...
.tb.on{color:var(--accent);border-color:var(--accent);background:rgba(232,160,32,.1)}

/* === Items hover === */
.hi{transition:all .15s}
.hi:hover{background:#20202e}

/* === Textarea paste/editor === */
